...
/******************************************************************************************************
 * Função: Passar string to uppercase  - funcao para substituir ft_strupcase() que não faz parte do c standard
 *          
*******************************************************************************************************/
char	*ft_strupcase(char *str)
{
...
void pesquisar_animal()
{
	...
	{                                                   // busca linear, pois o campo nome não possui índice
		...
		if(strcmp(ft_strupcase(nome_aux), ft_strupcase(nome)) == 0)             		// verifica se é igual
		{
